...
SOURCEFILES_QUOTED_IF_SPACED=configuration_bits.c main.c system.c traps.c joystick.c misc.c uart_debug.c uart_rf.c ../car.X/commands.c ../car.X/message.c motor_commands.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/configuration_bits.o ${OBJECTDIR}/main.o ${OBJECTDIR}/system.o ${OBJECTDIR}/traps.o ${OBJECTDIR}/joystick.o ${OBJECTDIR}/misc.o ${OBJECTDIR}/uart_debug.o ${OBJECTDIR}/uart_rf.o ${OBJECTDIR}/_ext/2119607377/commands.o ${OBJECTDIR}/_ext/2119607377/message.o ${OBJECTDIR}/motor_commands.o
POSSIBLE_DEPFILES=${OBJECTDIR}/configuration_bits.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/system.o.d ${OBJECTDIR}/traps.o.d ${OBJECTDIR}/joystick.o.d ${OBJECTDIR}/misc.o.d ${OBJECTDIR}/uart_debug.o.d ${OBJECTDIR}/uart_rf.o.d ${OBJECTDIR}/_ext/2119607377/commands.o.d ${OBJECTDIR}/_ext/2119607377/message.o.d ${OBJECTDIR}/motor_commands.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/configuration_bits.o ${OBJECTDIR}/main.o ${OBJECTDIR}/system.o ${OBJECTDIR}/traps.o ${OBJECTDIR}/joystick.o ${OBJECTDIR}/misc.o ${OBJECTDIR}/uart_debug.o ${OBJECTDIR}/uart_rf.o ${OBJECTDIR}/_ext/2119607377/commands.o ${OBJECTDIR}/_ext/2119607377/message.o ${OBJECTDIR}/motor_commands.o

# Source Files
SOURCEFILES=configuration_bits.c main.c system.c traps.c joystick.c misc.c uart_debug.c uart_rf.c ../car.X/commands.c ../car.X/message.c motor_commands.c
...
${OBJECTDIR}/joystick.o: joystick.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  joystick.c  -o ${OBJECTDIR}/joystick.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/joystick.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1    -omf=elf -DXPRJ_XC16_dsPIC30F4013=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -msfr-warn=off  
...
${OBJECTDIR}/_ext/2119607377/commands.o: ../car.X/commands.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/2119607377" 
	@${RM} ${OBJECTDIR}/_ext/2119607377/commands.o.d 
	@${RM} ${OBJECTDIR}/_ext/2119607377/commands.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../car.X/commands.c  -o ${OBJECTDIR}/_ext/2119607377/commands.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/2119607377/commands.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1    -omf=elf -DXPRJ_XC16_dsPIC30F4013=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/_ext/2119607377/commands.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/_ext/2119607377/message.o: ../car.X/message.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/2119607377" 
	@${RM} ${OBJECTDIR}/_ext/2119607377/message.o.d 
	@${RM} ${OBJECTDIR}/_ext/2119607377/message.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../car.X/message.c  -o ${OBJECTDIR}/_ext/2119607377/message.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/2119607377/message.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1    -omf=elf -DXPRJ_XC16_dsPIC30F4013=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/_ext/2119607377/message.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/motor_commands.o: motor_commands.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  motor_commands.c  -o ${OBJECTDIR}/motor_commands.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/motor_commands.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1    -omf=elf -DXPRJ_XC16_dsPIC30F4013=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -msfr-warn=off  
...
${OBJECTDIR}/joystick.o: joystick.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/joystick.o.d 
	@${RM} ${OBJECTDIR}/joystick.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  joystick.c  -o ${OBJECTDIR}/joystick.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/joystick.o.d"        -g -omf=elf -DXPRJ_XC16_dsPIC30F4013=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/joystick.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/_ext/2119607377/commands.o: ../car.X/commands.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/2119607377/commands.o.d 
	@${RM} ${OBJECTDIR}/_ext/2119607377/commands.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../car.X/commands.c  -o ${OBJECTDIR}/_ext/2119607377/commands.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/2119607377/commands.o.d"        -g -omf=elf -DXPRJ_XC16_dsPIC30F4013=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/_ext/2119607377/commands.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/_ext/2119607377/message.o: ../car.X/message.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/2119607377/message.o.d 
	@${RM} ${OBJECTDIR}/_ext/2119607377/message.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../car.X/message.c  -o ${OBJECTDIR}/_ext/2119607377/message.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/2119607377/message.o.d"        -g -omf=elf -DXPRJ_XC16_dsPIC30F4013=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/_ext/2119607377/message.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/motor_commands.o: motor_commands.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/motor_commands.o.d 
	@${RM} ${OBJECTDIR}/motor_commands.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  motor_commands.c  -o ${OBJECTDIR}/motor_commands.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/motor_commands.o.d"        -g -omf=elf -DXPRJ_XC16_dsPIC30F4013=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/motor_commands.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
