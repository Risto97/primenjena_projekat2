...
void initRF()
{
  /* U1BRG = 0x0340; // 1200 baud rate on 16MHz */
  /* U1BRG = 0x0115; // 1200 baud rate on 16MHz */
  /* U1BRG = 0x0060; // 1200 baud rate on 16MHz */
  U1BRG = 0x000B; // 9600 baud rate on 16MHz
  IEC0bits.U1RXIE=1;
  U1STA&=0xfffc;
